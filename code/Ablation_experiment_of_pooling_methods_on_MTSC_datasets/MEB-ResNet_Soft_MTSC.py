...
nb_epochs = 250
run_times=10
method_name='R_2_multi_scale_SoftPool_RESNET_MTSC'
...
#            exec('x_{}={}'.format(i,keras.layers.Input((65,1,1,))),globals())
            ...
            multi_scale_1=SoftPool(input_shape[2],1)(x_0)
            multi_scale_2=SoftPool(input_shape[2],2)(x_0)
            multi_scale_3=SoftPool(input_shape[2],3)(x_0)
            multi_scale_4=SoftPool(input_shape[2],4)(x_0)
            multi_scale_5=SoftPool(input_shape[2],5)(x_0)
