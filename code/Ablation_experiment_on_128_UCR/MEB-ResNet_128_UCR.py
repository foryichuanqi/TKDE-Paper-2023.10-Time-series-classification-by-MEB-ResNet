...
nb_epochs = 1500
run_times=10
method_name='MEB-ResNet_128_UCR'
...
#        with open(last_last_path + r"/fluid_based_time_series_calssification/experiments_result/log/{}_dataset_{}_log{}.txt".format(method_name,str(flist.index(each)),i), 'wb') as file_txt:
##        with open(last_last_path + r"/fluid_based_time_series_calssification/experiments_result/log/{}_dataset_{}_log{}_time{}.txt".format(method_name,str(flist.index(each)),i,str(datetime.datetime.now())), 'wb') as file_txt:
